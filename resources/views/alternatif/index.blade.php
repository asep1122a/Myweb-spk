        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <a href="{{ route('alternatif.create') }}" class="inline-block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 mb-4">Tambah Provider</a>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nama Provider</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($alternatifs as $alternatif)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 font-medium">{{ $alternatif->nama_provider }}</td>
                                    @foreach($kriterias as $kriteria)
                                        <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 flex items-center space-x-2">
                                        ...
                                        <form action="{{ route('alternatif.destroy', $alternatif->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus Provider ini?');">
                                            @csrf
                                            @method('DELETE')
