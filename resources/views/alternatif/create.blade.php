                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('alternatif.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_provider" id="nama_provider" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        </div>
                        <hr class="my-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Nilai Kriteria Paket</h3>
