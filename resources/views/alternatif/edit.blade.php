...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Data Provider: ') . $alternatif->nama_provider }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('alternatif.update', $alternatif->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="nama_provider" class="block text-sm font-medium text-gray-700">Nama Provider</label>
                            <input type="text" name="nama_provider" id="nama_provider" value="{{ old('nama_provider', $alternatif->nama_provider) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        </div>
                        <hr class="my-6">
