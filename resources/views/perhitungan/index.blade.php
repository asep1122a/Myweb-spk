                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($alternatifs as $alternatif)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900 dark:text-gray-200">{{ $alternatif->nama_provider }}</td>
                                            @foreach($kriterias as $kriteria)
                                                <!-- PERBAIKAN DI SINI: Tambahkan kelas dark:text-gray-200 -->
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700/50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Nama Provider</th>
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($rankings as $index => $rank)
                                        <tr class="{{ $index === 0 ? 'bg-green-500/10' : '' }}">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900 dark:text-gray-200">{{ $rank['nama_provider'] }}</td>
